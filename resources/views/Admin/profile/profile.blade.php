                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                ...
                                                <h6 class="text-muted">Dummy</h6>
                                                <small class="text-muted">Dummy</small>
                                                <div class="staff-id">Employee ID : RC_diii12</div>
                                                <div class="small doj text-muted">Date of Join : Dummy</div>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <div class="text"><a href="">Dummy</a></div>
                                                </li>
                                                <li>
